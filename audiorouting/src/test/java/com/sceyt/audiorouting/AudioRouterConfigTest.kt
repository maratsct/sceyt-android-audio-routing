...
class AudioRouterConfigTest {
    ...
    fun `default config has correct values`() {
        ...
        assertEquals(7, config.preferredDeviceOrder.size)
        assertEquals(AudioDevice.HearingAid::class, config.preferredDeviceOrder[0])
        assertEquals(AudioDevice.BluetoothHeadset::class, config.preferredDeviceOrder[1])
        assertEquals(AudioDevice.BleHeadset::class, config.preferredDeviceOrder[2])
        assertEquals(AudioDevice.WiredHeadset::class, config.preferredDeviceOrder[3])
        assertEquals(AudioDevice.UsbHeadset::class, config.preferredDeviceOrder[4])
        assertEquals(AudioDevice.Earpiece::class, config.preferredDeviceOrder[5])
        assertEquals(AudioDevice.Speakerphone::class, config.preferredDeviceOrder[6])
